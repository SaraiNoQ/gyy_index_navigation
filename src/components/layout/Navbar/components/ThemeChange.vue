...
<template>
  <div title="Change Theme" class="dropdown dropdown-end">
    <div tabindex="0" class="btn btn-ghost gap-1 normal-case">
      ...
      <span class="hidden md:inline tracking-wider">页面风格</span>
      <svg
        width="12px"
        height="12px"
    ...
    <div
      class="scrollbar dropdown-content rounded-t-box rounded-b-box top-px mt-16 h-[134px] max-h-96 w-52 overflow-y-auto bg-base-200 text-base-content shadow-2xl"
    >
          ...
          >
            <div class="grid grid-cols-5 grid-rows-3">
              <div class="col-span-5 row-span-3 row-start-1 flex gap-1 py-3 px-4">
                <div class="flex-grow text-sm font-bold tracking-widest font-kai">
                  {{ theme.name }}
                </div>
